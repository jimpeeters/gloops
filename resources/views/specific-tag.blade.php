...
<section class="specific-tag" data-ng-controller="SpecificTagController" data-ng-init="getLoopsFromTag('{{ $tagname }}')">
	<div class="col-xs-12">
		<h2 class="title">{{ $tagname }}</h2>
	</div>

	<div class="col-xs-12 col-sm-6 col-lg-4" data-ng-controller="LoopController" data-ng-repeat="loop in loops | limitTo:loopLimit" data-ng-init="isFavourite=loop.isFavourite">
	...
	<div data-ng-show="loops.length > 9" class="col-xs-12">
        <button class="basic-button load-more-button" data-ng-class="{ hide: loopLimit >= loops.length }" href="" data-ng-click="loopLimit = loopLimit + 3">Load more</button>
    </div>
